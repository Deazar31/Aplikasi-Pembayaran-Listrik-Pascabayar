...
if (isset($_POST['login'])) {
    ...
    $query = mysqli_query($koneksi, "SELECT * FROM admin WHERE (username='$user' OR email='$user') AND password='$pass'");
...
<head>
    ...
    <style>
        body {
            background: url('png/listrik login home.jpg') no-repeat center center fixed;
