...
if (isset($_POST['register'])) {
    ...
    if ($cek > 0) {
        ...
        mysqli_query($koneksi, "INSERT INTO pelanggan (id_pelanggan, nama, password, email, alamat, daya, tanggal_registrasi) VALUES ('$username', '$nama', '$hashed_password', '$email', '$alamat', '$daya', '$tanggal_registrasi')");
